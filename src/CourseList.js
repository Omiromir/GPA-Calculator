...
export function CourseList({ onCoursesChange }) {
  ...
  function handelCoursesChange(index, field, value) {
  ...
  return (
    <ul className="course-list">
      {courses.map((course, index) => (
        <CourseItem key={index} course={course} onChange={(field, value) => handelCoursesChange(index, field, value)}/>
      ))}
      <div>
